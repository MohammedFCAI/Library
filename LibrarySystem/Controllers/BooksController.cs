...
namespace LibrarySystem.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<BookDto>>> GetBooks()
        {
            ...
            var bookDtos = books.Select(b => new BookDto { Id = b.Id, Title = b.Title, Author = b.Author, Category = new CategoryDto { Id = b.Category.Id, Name = b.Category.Name }, Quantity = b.Quantity }).ToList();
            return Ok(bookDtos);
        }
